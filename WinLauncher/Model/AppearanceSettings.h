...
namespace Model
{
    ...
    struct AppearanceSettings
    {
        ...
        ThemeEffectConfig light = { 36.0f, 20.0f, 0.50f, 0.90f, 0.90f, 2.5f };
        ...
        ThemeEffectConfig glassDark = { 32.0f, 20.0f, 0.30f, 0.90f, 0.90f, 2.5f };
        ThemeEffectConfig glassLight = { 36.0f, 20.0f, 0.30f, 0.90f, 0.90f, 2.5f };
    };
}
