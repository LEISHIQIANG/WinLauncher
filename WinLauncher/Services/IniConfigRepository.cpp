...
class IniConfigRepository::Impl final : public IConfigService
{
public:
    static constexpr int AutoBackupDebounceSeconds = 180;

    explicit Impl(Logger* logger = nullptr, HWND notifyHwnd = nullptr, UINT notifyMessage = 0, const std::wstring& configDirectory = L"")
        : m_logger(logger)
        ...
        , m_autoUpdate(true)
    {
        m_configDir = configDirectory.empty() ? ConfigPath::PrepareUserConfigDirectory() : configDirectory;
...
public:
    ...
    virtual std::vector<Model::PopupPage> LoadConfig() override
    {
        ...
        std::wstring content = ConfigFileStore::ReadUtf8(m_configFilePath);
        if (content.empty())
        {
        ...
        while (std::getline(wss, line))
        {
            ...
            else if (inSettings)
            {
                ...
                if (eq != std::wstring::npos)
                {
                    ...
                    std::wstring val = IniConfigDocument::Unescape(line.substr(eq + 1));
                    Trim(key); Trim(val);
    ...
    virtual void SaveConfig(const std::vector<Model::PopupPage>& pages) override
    {
        ...
        content += L"TriggerBlacklist=" + IniConfigDocument::Escape(JoinListValue(m_triggerBlacklist)) + L"\r\n";
        ...
        for (const auto& page : pages)
        {
            ...
            content += L"Name=" + IniConfigDocument::Escape(page.name) + L"\r\n";
            ...
            if (!page.sceneApps.empty())
            {
                ...
                {
                    content += L"SceneApp" + std::to_wstring(appIndex) + L"=" + IniConfigDocument::Escape(page.sceneApps[appIndex]) + L"\r\n";
                }
            }
            if (!page.sceneAvailableApps.empty())
            {
                ...
                {
                    content += L"SceneAvailableApp" + std::to_wstring(appIndex) + L"=" + IniConfigDocument::Escape(page.sceneAvailableApps[appIndex]) + L"\r\n";
                }
            }
            content += L"\r\n";
            ...
            for (const auto& sc : page.shortcuts)
            {
                ...
                content += L"Id=" + IniConfigDocument::Escape(sc.id.empty() ? GenerateGUID() : sc.id) + L"\r\n";
                content += L"Name=" + IniConfigDocument::Escape(sc.name) + L"\r\n";
                ...
                content += L"TargetPath=" + IniConfigDocument::Escape(sc.targetPath) + L"\r\n";
                content += L"Arguments=" + IniConfigDocument::Escape(sc.arguments) + L"\r\n";
                ...
                content += L"IconPath=" + IniConfigDocument::Escape(sc.iconPath) + L"\r\n";
                content += L"BuiltinIconId=" + IniConfigDocument::Escape(sc.builtinIconId) + L"\r\n";
    ...
    {
        if (!FlushPendingConfig()) return false;
        if (!ConfigFileStore::IsPathUnderDirectory(m_historyDir, backupPath))
        {
...
private:
    ...
    {
        const bool hadExistingContent = GetFileAttributesW(path.c_str()) != INVALID_FILE_ATTRIBUTES;
        bool contentChanged = false;
        if (!ConfigFileStore::AtomicWriteUtf8(path, wstr, contentChanged))
            return false;
        if (contentChanged && hadExistingContent)
            ScheduleAutoBackup();
        PruneConfigHistory(10);
        return true;
    }
...
IniConfigRepository::IniConfigRepository(Logger* logger, HWND notifyHwnd, UINT notifyMessage)
    : m_impl(std::make_unique<Impl>(logger, notifyHwnd, notifyMessage)) {}
IniConfigRepository::IniConfigRepository(const std::wstring& configDirectory, Logger* logger, HWND notifyHwnd, UINT notifyMessage)
    : m_impl(std::make_unique<Impl>(logger, notifyHwnd, notifyMessage, configDirectory)) {}
...
std::wstring IniConfigRepository::GetConfigHistoryDir() const { return m_impl->GetConfigHistoryDir(); }
std::vector<ConfigHistoryEntry> IniConfigRepository::GetConfigHistory() { return m_impl->GetConfigHistory(); }
bool IniConfigRepository::CreateConfigBackup(const std::wstring& reason) { return m_impl->CreateConfigBackup(reason); }
bool IniConfigRepository::RestoreConfigBackup(const std::wstring& path) { return m_impl->RestoreConfigBackup(path); }
bool IniConfigRepository::ClearConfig() { return m_impl->ClearConfig(); }
bool IniConfigRepository::ClearConfigHistory() { return m_impl->ClearConfigHistory(); }
Model::AppearanceSettings IniConfigRepository::GetAppearanceSettings() const { return m_impl->GetAppearanceSettings(); }
void IniConfigRepository::SetAppearanceSettings(const Model::AppearanceSettings& value) { m_impl->SetAppearanceSettings(value); }
int IniConfigRepository::GetTriggerType() { return m_impl->GetTriggerType(); }
void IniConfigRepository::SetTriggerType(int value) { m_impl->SetTriggerType(value); }
std::vector<std::wstring> IniConfigRepository::GetTriggerBlacklist() { return m_impl->GetTriggerBlacklist(); }
void IniConfigRepository::SetTriggerBlacklist(const std::vector<std::wstring>& value) { m_impl->SetTriggerBlacklist(value); }
bool IniConfigRepository::GetAutoStart() { return m_impl->GetAutoStart(); }
void IniConfigRepository::SetAutoStart(bool value) { m_impl->SetAutoStart(value); }
bool IniConfigRepository::GetHideTrayIcon() { return m_impl->GetHideTrayIcon(); }
void IniConfigRepository::SetHideTrayIcon(bool value) { m_impl->SetHideTrayIcon(value); }
bool IniConfigRepository::GetAutoUpdate() { return m_impl->GetAutoUpdate(); }
void IniConfigRepository::SetAutoUpdate(bool value) { m_impl->SetAutoUpdate(value); }
int IniConfigRepository::GetPopupColumns() { return m_impl->GetPopupColumns(); }
void IniConfigRepository::SetPopupColumns(int value) { m_impl->SetPopupColumns(value); }
int IniConfigRepository::GetPopupRows() { return m_impl->GetPopupRows(); }
void IniConfigRepository::SetPopupRows(int value) { m_impl->SetPopupRows(value); }
int IniConfigRepository::GetPopupIconSize() { return m_impl->GetPopupIconSize(); }
void IniConfigRepository::SetPopupIconSize(int value) { m_impl->SetPopupIconSize(value); }
int IniConfigRepository::GetPopupIconLabelFontSize() { return m_impl->GetPopupIconLabelFontSize(); }
void IniConfigRepository::SetPopupIconLabelFontSize(int value) { m_impl->SetPopupIconLabelFontSize(value); }
int IniConfigRepository::GetPopupHeaderSizeLevel() { return m_impl->GetPopupHeaderSizeLevel(); }
void IniConfigRepository::SetPopupHeaderSizeLevel(int value) { m_impl->SetPopupHeaderSizeLevel(value); }
int IniConfigRepository::GetPopupIconGap() { return m_impl->GetPopupIconGap(); }
void IniConfigRepository::SetPopupIconGap(int value) { m_impl->SetPopupIconGap(value); }
int IniConfigRepository::GetPopupIconRadius() { return m_impl->GetPopupIconRadius(); }
void IniConfigRepository::SetPopupIconRadius(int value) { m_impl->SetPopupIconRadius(value); }
int IniConfigRepository::GetPopupWndPadding() { return m_impl->GetPopupWndPadding(); }
void IniConfigRepository::SetPopupWndPadding(int value) { m_impl->SetPopupWndPadding(value); }
int IniConfigRepository::GetTheme() { return m_impl->GetTheme(); }
void IniConfigRepository::SetTheme(int value) { m_impl->SetTheme(value); }
int IniConfigRepository::GetThemeColor() { return m_impl->GetThemeColor(); }
void IniConfigRepository::SetThemeColor(int value) { m_impl->SetThemeColor(value); }
int IniConfigRepository::GetWindowMode() { return m_impl->GetWindowMode(); }
void IniConfigRepository::SetWindowMode(int value) { m_impl->SetWindowMode(value); }
int IniConfigRepository::GetGlobalScalePercent() { return m_impl->GetGlobalScalePercent(); }
bool IniConfigRepository::HasCustomGlobalScalePercent() { return m_impl->HasCustomGlobalScalePercent(); }
void IniConfigRepository::SetGlobalScalePercent(int value) { m_impl->SetGlobalScalePercent(value); }
int IniConfigRepository::GetDockHeight() { return m_impl->GetDockHeight(); }
void IniConfigRepository::SetDockHeight(int value) { m_impl->SetDockHeight(value); }
bool IniConfigRepository::GetSearchMode() { return m_impl->GetSearchMode(); }
void IniConfigRepository::SetSearchMode(bool value) { m_impl->SetSearchMode(value); }
int IniConfigRepository::GetPopupAlignMode() { return m_impl->GetPopupAlignMode(); }
void IniConfigRepository::SetPopupAlignMode(int value) { m_impl->SetPopupAlignMode(value); }
bool IniConfigRepository::GetPopupAutoClose() { return m_impl->GetPopupAutoClose(); }
void IniConfigRepository::SetPopupAutoClose(bool value) { m_impl->SetPopupAutoClose(value); }
bool IniConfigRepository::GetPopupMultiOpenWhenPinned() { return m_impl->GetPopupMultiOpenWhenPinned(); }
void IniConfigRepository::SetPopupMultiOpenWhenPinned(bool value) { m_impl->SetPopupMultiOpenWhenPinned(value); }
int IniConfigRepository::GetHoverLeaveDelay() { return m_impl->GetHoverLeaveDelay(); }
void IniConfigRepository::SetHoverLeaveDelay(int value) { m_impl->SetHoverLeaveDelay(value); }
int IniConfigRepository::GetFileSelectionValiditySeconds() { return m_impl->GetFileSelectionValiditySeconds(); }
void IniConfigRepository::SetFileSelectionValiditySeconds(int value) { m_impl->SetFileSelectionValiditySeconds(value); }
int IniConfigRepository::GetSortMode() { return m_impl->GetSortMode(); }
void IniConfigRepository::SetSortMode(int value) { m_impl->SetSortMode(value); }
bool IniConfigRepository::GetAnimationEnabled() { return m_impl->GetAnimationEnabled(); }
void IniConfigRepository::SetAnimationEnabled(bool value) { m_impl->SetAnimationEnabled(value); }
int IniConfigRepository::GetAnimationDuration() { return m_impl->GetAnimationDuration(); }
void IniConfigRepository::SetAnimationDuration(int value) { m_impl->SetAnimationDuration(value); }
bool IniConfigRepository::GetHardwareAccelerationEnabled() { return m_impl->GetHardwareAccelerationEnabled(); }
void IniConfigRepository::SetHardwareAccelerationEnabled(bool value) { m_impl->SetHardwareAccelerationEnabled(value); }
